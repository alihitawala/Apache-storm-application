...
public class TwitterSpoutQuestion2 extends BaseRichSpout {
	...
	public TwitterSpoutQuestion2(String consumerKey, String consumerSecret,
...
//		query.track(stopWords.toArray(new String[stopWords.size()]));
